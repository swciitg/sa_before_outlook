<?php
	...
	if (isset($_POST['Submit'])) {
		if ($fno == ''){
			...
			$success = "An announcement with title - <b>$fno</b> is successfully published.";
			mysql_query("INSERT INTO `announcements` VALUES ('','$time_d','$time_m','$time_y','$fno','$fdesc','$onlinelink')");
		}
	}
?>
			<div id="page-wrapper">
