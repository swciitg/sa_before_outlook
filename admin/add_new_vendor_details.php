<?php
	...
	if (isset($_POST['Submit'])) {
		if ($vendor_name == ''){
			...
			$row_query = mysql_query("SELECT * FROM vendor_details");
			$row_count = mysql_num_rows($row_query);
			$row_count = $row_count +1;	
			mysql_query("INSERT INTO `vendor_details` VALUES ('','$vendor_name','$buisness_type','$pdf')");
