<?php 
	...
	include("connect.php");
	$query2 = "SELECT * FROM disciplinary_cases WHERE status = 'closed' ORDER BY booking_time DESC";
                    ...
                    <div class="col-lg-12">
						...
						<th>Date of Incident</th>												
										...
										<?php 
											...
											?>
                                            <tr class="odd gradeX" <?php if($row["status"] == "closed"){echo "style='color:green'";}?>>
