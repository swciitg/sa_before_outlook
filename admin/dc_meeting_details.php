<?php
	...
	$query2 = "SELECT * FROM `disciplinary_meeting_details`";
	...
	if($i_value!=''){
			...
			while($i<$i_value){
				...
				$decision_check = $_POST['decision'.$i];
				if($date_check==''){
					$blank_row='yes';
					break;
				}
	...
	if (isset($_POST['Submit'])) {
		if($date=='' OR $blank_row=='yes'){
			...
			mysql_query("INSERT INTO `disciplinary_meeting_details` VALUES ('','$application_no','$date','$decision','$curdatetime')");
			if($i_value!=''){
				$i=1;
				while($i<$i_value){
					$date_var = $_POST['date'.$i];
					$decision_var = $_POST['decision'.$i];
					mysql_query("INSERT INTO `disciplinary_meeting_details` VALUES ('','$application_no','$date_var','$decision_var','$curdatetime')");
					$i++;
				}
			}	
		}
...
<script type='text/javascript'>
	...
	$( ".date_2" ).datepicker({dateFormat: "yy-mm-dd",showAnim: "slideDown" });
	...
	$(document).ready(function(){
	     ...
	     $("#add_row").click(function(){
	      ...
	      $('#addr'+i).html("<td>"+ (i+1) +"</td><td><div class='input-group date'><span class='input-group-addon'><i class='fa fa-calendar'></i> </span><input name='date"+i+"' type='text' placeholder='Meeting Date' class='form-control date_2' /> </div></td><td><textarea  name='decision"+i+"' type='text' placeholder='Decision'  class='form-control input-md'></textarea></td>");
			...
			<div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<?php echo "<div style='font-size:110%; color:#198822' class='form-group col-lg-12'>Add Meeting Details(Application No.:$application_no)</div>"; ?>
							...
							<table class="table table-bordered table-hover" id="tab_logic">
								...
								<tbody>
									<tr id='addr0'>
										...
										<input type="text" name='date0' id='date' placeholder="Meeting Date"  class="form-control datepicker" data-date-format="yyyy-mm-dd"/>
										</div>
										</td>
										<td><textarea type="text" name='decision0' placeholder="Decision" class="form-control"></textarea>
										</td>
									</tr>
						    <tr id='addr1'></tr>
						    <tr id='value_i'></tr>
						   ...
						   <div class="col-lg-5"></div>
							...
							<div class="col-lg-2">
								<div class="form-group ">
									...
									<button type="submit" class="btn btn-primary" name="Submit" >Add Meeting(s)</button>
								</div>
							</div>
							<div class="col-lg-5"></div>
						</div>
