<?php
	...
	if (isset($_POST['Submit'])) {
		if ($fno == ''){
			...
			mysql_query ("UPDATE achievements SET title = '$fno' WHERE id = '$id'");
			mysql_query ("UPDATE achievements SET description = '$fdesc' WHERE id = '$id'");
			mysql_query ("UPDATE achievements SET link = '$onlinelink' WHERE id = '$id'");
		}
	}
