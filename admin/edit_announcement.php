<?php
	...
	$id = $_GET['edit'];
	$fno = $_POST['annoctitle'];
	$fdesc = $_POST['annocdesc'];
	...
	if (isset($_POST['Submit'])) {
		if ($fno == ''){
			...
			mysql_query ("UPDATE announcements SET title = '$fno' WHERE id = '$id'");
			mysql_query ("UPDATE announcements SET description = '$fdesc' WHERE id = '$id'");
			mysql_query ("UPDATE announcements SET link = '$onlinelink' WHERE id = '$id'");
		}
	}
                                    ...
                                    <div class="col-lg-12">
                                        <form name="form2" method="POST" class="col s12" action="" enctype="multipart/form-data">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input class="form-control" name="annoctitle" value="<?php echo $row["title"]; ?>">
                                            </div>
											<div class="form-group col-md-6">
                                                <label>Short Description</label>
                                                <input class="form-control" name="annocdesc" value="<?php echo $row["description"]; ?>">
                                            </div>
											<div class="form-group col-md-6">
