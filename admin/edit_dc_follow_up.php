<?php
	...
	$query2 = "SELECT * FROM `disciplinary_follow_up` WHERE id='$id'";
	...
	if (isset($_POST['Submit'])) {
		if($date==''){
			...
			mysql_query("UPDATE `disciplinary_follow_up` SET date='$date' WHERE id='$id'");
			mysql_query("UPDATE `disciplinary_follow_up` SET details ='$details' WHERE id='$id'");
			mysql_query("UPDATE `disciplinary_follow_up` SET remarks ='$remarks' WHERE id='$id'");
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <form name="meeting" class="before_success" accept-charset="utf-8" method="post"  action="" enctype="multipart/form-data">
                                            	<?php echo "<div style='font-size:110%; color:#198822' class='form-group col-lg-12'>Add Follow Up Details(Application No.:$row_track[app_no])</div>"; ?>
							...
							<table class="table table-bordered table-hover" id="tab_logic">
								...
								<tbody>
									<tr id='addr0'>
										...
										<input type="text" name='date0' id='date' placeholder="Date"  class="form-control datepicker" data-date-format="yyyy-mm-dd" value="<?php echo $row_track['date'];?>" />
										</div>
										</td>
										<td><textarea type="text" name='details0' placeholder="Details" class="form-control" value="" ><?php echo $row_track['details'];?></textarea>
										</td>
										</td>
										<td><textarea type="text" name='remarks0' placeholder="Remarks" class="form-control" value="" ><?php echo $row_track['remarks'];?></textarea>
										</td>
									</tr>
						    	</tbody>
							</table>
						   ...
						   <div class="col-lg-5"></div>
							...
							<div class="col-lg-2">
								<div class="form-group ">
									...
									<button type="submit" class="btn btn-primary" name="Submit" >Update Follow Up</button>
								</div>
							</div>
							<div class="col-lg-5"></div>
						</div>
