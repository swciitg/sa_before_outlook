<?php
	...
	if (isset($_POST['Submit'])) {
		if ($fno == ''){
			...
			mysql_query ("UPDATE rules_menu SET title = '$fno' WHERE id = '$id'");
			mysql_query ("UPDATE rules_menu SET link = '$onlinelink' WHERE id = '$id'");
		}
	}
	$query = "SELECT * FROM rules_menu WHERE id = '$id' ";
