<?php
	...
	if (isset($_POST['Submit'])) {
		if ($fno == ''){
			...
			mysql_query ("UPDATE sac_minutes SET title = '$fno' WHERE id = '$id'");
			mysql_query ("UPDATE sac_minutes SET link = '$onlinelink' WHERE id = '$id'");
		}
	}
	$query = "SELECT * FROM sac_minutes WHERE id = '$id' ";
