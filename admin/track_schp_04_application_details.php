<?php 
	...
	$query_sa = 'Query: '.$_POST['query_sa'];
	$query_adosa_2 = 'Query: '.$_POST['query_adosa_2'];
	$query_adosa_1 = 'Query: '.$_POST['query_adosa_1'];
	$query_hossa = 'Query: '.$_POST['query_hossa'];
	$query_dosa = 'Query: '.$_POST['query_dosa'];	
...
//	$adosa_2 = $_POST['adosa_2'];
	...
	if (isset($_POST['Submit_sa'])) {
		if($comment_sa ==''){
			...
			mysql_query("INSERT INTO schp_04_movement VALUES ('','$id','$current_location','$name','$comment_sa','$curdatetime','no')");
	...
	if (isset($_POST['Submit_hossa'])) {
		if($comment_hossa ==''){
			...
			mysql_query("INSERT INTO schp_04_movement VALUES ('','$id','$current_location','$name','$comment_hossa','$curdatetime','no')");
	...
	if (isset($_POST['Submit_adosa_1'])) {
		if($comment_adosa_1 ==''){
			...
			mysql_query("INSERT INTO schp_04_movement VALUES ('','$id','$current_location','$name','$comment_adosa_1','$curdatetime','no')");
	...
	if (isset($_POST['Submit_adosa_2'])) {
		if($comment_adosa_2==''){
			...
			mysql_query("INSERT INTO schp_04_movement VALUES ('','$id','$current_location','$name','$comment_adosa_2','$curdatetime','no')");
	...
	if (isset($_POST['Submit_dosa'])) {
		if($comment_dosa ==''){
			...
			mysql_query("INSERT INTO schp_04_movement VALUES ('','$id','$current_location','$name','$comment_dosa','$curdatetime','no')");
...
// query raised...............	
		...
		if($query_sa ==''){
			...
			mysql_query("INSERT INTO schp_04_movement VALUES ('','$id','$current_location','$name','$query_sa','$curdatetime','yes')");
			...
			mysql_query ("UPDATE schp_04 SET status='A Query has been Raised of by Saoff' WHERE application_no = '$id'");
	...
	if (isset($_POST['Submit1_hossa'])) {
		if($query_hossa ==''){
			...
			mysql_query("INSERT INTO schp_04_movement VALUES ('','$id','$current_location','$name','$query_hossa','$curdatetime','yes')");
	...
	if (isset($_POST['Submit1_adosa_1'])) {
		if($query_adosa_1 ==''){
			...
			mysql_query("INSERT INTO schp_04_movement VALUES ('','$id','$current_location','$name','$query_adosa_1','$curdatetime','yes')");
	...
	if (isset($_POST['Submit1_adosa_2'])) {
		if($query_adosa_2==''){
			...
			mysql_query("INSERT INTO schp_04_movement VALUES ('','$id','$current_location','$name','$query_adosa_2','$curdatetime','yes')");
	...
	if (isset($_POST['Submit1_dosa'])) {
		if($query_dosa ==''){
			...
			mysql_query("INSERT INTO schp_04_movement VALUES ('','$id','$current_location','$name','$query_dosa','$curdatetime','yes')");
...
//////
	...
	if (isset($_POST['Approve'])) {
		if ($login_session == 'adosa_1'){
			...
			mysql_query("INSERT INTO schp_04_movement VALUES ('','$id','$current_location','$name','Approved by adosa_1','$curdatetime','no')");
			$message = "Dear ".$applicant."\r\n Your Scholarship Application (Application No. ".$id.") has been approved by Adosa_1. Please collect your approved application from SA office. \r\n Latest status can be tracked via CLS.\r\n Thanking You.\r\n Regards,\r\n Team SWC";
			$headers = "MIME-Version: 1.0" . "\r\n";
			$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
			$headers .= 'From: SWC, IIT Guwahati <swc@iitg.ernet.in>' . "\r\n";
			//$headers .= 'Cc: swc@iitg.ernet.in, saoff@iitg.ernet.in, hossa@iitg.ernet.in' . "\r\n";
			$user_webmail = $applicant_webmail."@iitg.ernet.in";
			mail($user_webmail , 'Scholarship application approved by ADOSA1' , $message , $headers);
	    }
			...
			mysql_query ("UPDATE schp_04 SET approve_dean='yes' WHERE application_no = '$id'");
			mysql_query ("UPDATE schp_04 SET status='approved' WHERE application_no = '$id'");
			mysql_query("INSERT INTO schp_04_movement VALUES ('','$id','$current_location','$name','Approved by adosa_2','$curdatetime','no')");
			$message = "Dear ".$applicant."\r\n Your Scholarship Application (Application No. ".$id.") has been approved by Adosa_2. Please collect your approved application from SA office. \r\n Latest status can be tracked via CLS.\r\n Thanking You.\r\n Regards,\r\n Team SWC";
			$headers = "MIME-Version: 1.0" . "\r\n";
			$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
			$headers .= 'From: SWC, IIT Guwahati <swc@iitg.ernet.in>' . "\r\n";
			//$headers .= 'Cc: swc@iitg.ernet.in, saoff@iitg.ernet.in, hossa@iitg.ernet.in' . "\r\n";
			$user_webmail = $applicant_webmail."@iitg.ernet.in";
			mail($user_webmail , 'Scholarship application approved by ADOSA2' , $message , $headers);
	    }
		else if ($login_session == 'dos'){
			$approve_success = "Application approved by dosa";
			mysql_query ("UPDATE schp_04 SET approve_dean='yes'  WHERE application_no = '$id'");
			mysql_query ("UPDATE schp_04 SET status='approved' WHERE application_no = '$id'");
			mysql_query("INSERT INTO schp_04_movement VALUES ('','$id','$current_location','$name','Approved by Dosa','$curdatetime','no')");
			$message = "Dear ".$applicant."\r\n Your MCH booking request (Application No. ".$id.") has been approved by Dosa. Please collect your approved sapplication from SA office. \r\n Latest status can be tracked via CLS.\r\n Thanking You.\r\n Regards,\r\n Team SWC";
			$headers = "MIME-Version: 1.0" . "\r\n";
			$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
			$headers .= 'From: SWC, IIT Guwahati <swc@iitg.ernet.in>' . "\r\n";
			//$headers .= 'Cc: swc@iitg.ernet.in, saoff@iitg.ernet.in, hossa@iitg.ernet.in' . "\r\n";
			$user_webmail = $applicant_webmail."@iitg.ernet.in";
			mail($user_webmail , 'Scholarship application approved by DOSA' , $message , $headers);
	    }
		else{
			...
			mysql_query("INSERT INTO schp_04_movement VALUES ('','$id','$current_location','$name','Approved and Forwarded to HoSSA','$curdatetime','no')");
			...
			//$headers .= 'Cc: swc@iitg.ernet.in, saoff@iitg.ernet.in, hossa@iitg.ernet.in' . "\r\n";
			$user_webmail = $applicant_webmail."@iitg.ernet.in";
			//mail($user_webmail , 'Scholarship application forwarded to HoSSA' , $message , $headers);
	    }
	}
	if (isset($_POST['Reject']) AND ($login_session != 'adosa_1' OR $login_session != 'adosa_2' OR $login_session != 'dos')) {
		if($login_session == 'hossa'){
			...
			mysql_query("INSERT INTO schp_04_movement VALUES ('','$id','$current_location','$name','Rejected by HoSSA','$curdatetime','no')");
			$message = "Dear ".$applicant."\r\n Your Scholarship Application (Application No. ".$id.") has been rejected by HoSSA. \r\n Latest status can be tracked via CLS.\r\n Thanking You.\r\n Regards,\r\n Team SWC";
			$headers = "MIME-Version: 1.0" . "\r\n";
			$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
			$headers .= 'From: SWC, IIT Guwahati <swc@iitg.ernet.in>' . "\r\n";
			//$headers .= 'Cc: swc@iitg.ernet.in, saoff@iitg.ernet.in, hossa@iitg.ernet.in' . "\r\n";
			$user_webmail = $applicant_webmail."@iitg.ernet.in";
			mail($user_webmail , 'Scholarship application rejected by HoSSA' , $message , $headers);
		}
			...
			mysql_query("INSERT INTO schp_04_movement VALUES ('','$id','$current_location','$name','Rejected by Students Affairs Office','$curdatetime','no')");
			$message = "Dear ".$applicant."\r\n Your Scholarship Application (Application No. ".$id.") has been rejected by SA Office. \r\n Latest status can be tracked via CLS.\r\n Thanking You.\r\n Regards,\r\n Team SWC";
			$headers = "MIME-Version: 1.0" . "\r\n";
			$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
			$headers .= 'From: SWC, IIT Guwahati <swc@iitg.ernet.in>' . "\r\n";
			//$headers .= 'Cc: swc@iitg.ernet.in, saoff@iitg.ernet.in' . "\r\n";
			$user_webmail = $applicant_webmail."@iitg.ernet.in";
			mail($user_webmail , 'Scholarship application rejected by SA Office' , $message , $headers);
		}
	}
	if (isset($_POST['Reject']) AND ($login_session == 'adosa_1' OR $login_session == 'adosa_2' OR $login_session == 'dos')) {
		$reject_success = "Rejected.";
		...
		mysql_query("INSERT INTO schp_04_movement VALUES ('','$id','$current_location','$name','Rejected by Dean','$curdatetime','no')");
		$message = "Dear ".$applicant."\r\n Your Scholarship Appplication (Application No. ".$id.") has been rejected by ".$login_session.". \r\n Latest status can be tracked via CLS.\r\n Thanking You.\r\n Regards,\r\n Team SWC";
			$headers = "MIME-Version: 1.0" . "\r\n";
			$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
			$headers .= 'From: SWC, IIT Guwahati <swc@iitg.ernet.in>' . "\r\n";
			//$headers .= 'Cc: swc@iitg.ernet.in, saoff@iitg.ernet.in, hossa@iitg.ernet.in, adosa_1@iitg.ernet.in, guesthouse@iitg.ernet.in' . "\r\n";
			$user_webmail = $applicant_webmail."@iitg.ernet.in";
			mail($user_webmail , 'Scholarship application rejected by Dean' , $message , $headers);
	}
// verify saoff
 	if (isset($_POST['Verify'])) {
			$approve_success = "Application Verified by saoff and Hardcopy Submission Request Sent";
			mysql_query ("UPDATE schp_04 SET status='Details Verified By Saoff' WHERE application_no = '$id'");
			mysql_query ("UPDATE schp_04 SET verify_saoff ='yes' WHERE application_no = '$id'");
			mysql_query("INSERT INTO schp_04_movement VALUES ('','$id','$current_location','$name','Details Verified By Saoff','$curdatetime','no')");
			$message = "Dear ".$applicant."\r\n Your Scholarship Application (Application No. ".$id.") has been Verifeid by Saoff. For Further Process Please submit the Hardcopy of the form that need to be signed by competent authority at Student's Affairs Office. \r\n Latest status can be tracked via CLS.\r\n Thanking You.\r\n Regards,\r\n Team SWC";
			$headers = "MIME-Version: 1.0" . "\r\n";
			$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
			$headers .= 'From: SWC, IIT Guwahati <swc@iitg.ernet.in>' . "\r\n";
			//$headers .= 'Cc: swc@iitg.ernet.in, saoff@iitg.ernet.in, hossa@iitg.ernet.in' . "\r\n";
			$user_webmail = $applicant_webmail."@iitg.ernet.in";
			mail($user_webmail , 'Details Verified by Saoff' , $message , $headers);
	    }
	...
	if(isset($_POST['dosa']) AND $login_session == 'hossa'){
		...
		mysql_query("INSERT INTO schp_04_movement VALUES ('','$id','$current_location','$name','Approved by Hossa and forwarded to Dosa','$curdatetime','no')");
	}
	if(isset($_POST['adosa_1']) AND $login_session == 'hossa'){
		...
		mysql_query ("UPDATE schp_04 SET approve_hossa='yes' WHERE application_no = '$id'");
		mysql_query("INSERT INTO schp_04_movement VALUES ('','$id','$current_location','$name','Approved by Hossa and forwarded to Adosa_1','$curdatetime','no')");
	}
	if(isset($_POST['adosa_2']) AND $login_session == 'hossa'){
		...
		mysql_query("INSERT INTO schp_04_movement VALUES ('','$id','$current_location','$name','Approved by Hossa and forwarded to Adosa_2.','$curdatetime','no')");
	}
...
?>
           ...
           <div class="table-responsive">
				<?php if($row_track['query_saoff']!='' OR $row_track['query_hossa']!='' OR $row_track['query_dean']!=''){ echo "<div style='font-size:150%; color:#198822'>Query Answer</div>"; ?>
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        <tbody> 
					   <?php if($row_track['query_saoff']!='' AND $row_track['query_ans_saoff']!=''){ ?>
					    <tr> 
							...
							<?php echo "<div style='font-size:150%; color:#198822'>Details of Scholarship</div>"; ?>
                             ...
                             <div class="table-responsive">
										...
										<?php
											...
											$result3 = mysql_query($query3);
												while($m_row = mysql_fetch_array($result3)){
													...
													if($m_row["query"] != 'no') {	
														echo "<td><font size='2' color = 'red'>$m_comment";		
													}
													else{
								...
								<?php if($row_track["status"] == "approved"){ ?>
									<button type="button" onclick="frames['frame1'].print()" class="btn btn-primary disabled">Application Approved</button>
								<?php } 
			...
			<tbody>
			  <tr>
     			  <td><form name="gh" style="margin-top:2%" class="before_approve" action=""  accept-charset="utf-8" method="post" enctype="multipart/form-data">
								...
								<?php }else {
								     if($row_track["verify_saoff"] ==  'yes') {	?>
								 <form action="" accept-charset="utf-8" method="post">
									<button type="submit" class="btn btn-success hide_approve" name="Approve">Forward to Hossa</button>
									<button type="submit" class="btn btn-danger hide_reject" name="Reject">Reject</button>
								</form> 
								
									 <?php } else { ?>
								<form action="" accept-charset="utf-8" method="post">
									<button type="submit" class="btn btn-success hide_approve" name="Verify">Verify Details and ask for hardcopy of application</button>
									<button type="submit" class="btn btn-danger hide_reject" name="Reject">Reject</button>
								</form> 
									<?php } ?>
									<table class="table table-striped table-bordered table-hover">
