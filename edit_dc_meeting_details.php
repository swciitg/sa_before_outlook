			...
			<div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<?php echo "<div style='font-size:110%; color:#198822' class='form-group col-lg-12'>Add Meeting Details(Application No.:$row_track[application_no])</div>"; ?>
							...
							<table class="table table-bordered table-hover" id="tab_logic">
								...
								<tbody>
									<tr id='addr0'>
										...
										<input type="text" name='date0' id='date' placeholder="Meeting Date"  class="form-control datepicker" data-date-format="yyyy-mm-dd" <?php echo $row_track['meeting_date'];?>/>
										</div>
										</td>
