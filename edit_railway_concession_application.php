<?php
	...
	$row_2 = mysql_fetch_array($result2);
    ...
    $query = "SELECT * FROM railway_concession_1 WHERE application_no=$application_no ";
    $result = mysql_query($query);
    $row_track = mysql_fetch_array($result);
    $id = $row_track['id'];

    $query3 = "SELECT * FROM railway_concession_2 WHERE id='$id' ";
    $result3 = mysql_query($query3);
    $row_count = mysql_num_rows($result3);
    while($row_3=mysql_fetch_array($result3)){
	$array[] = $row_3;
    } 

    $count=5-$row_count;
    $i=0;
    $query4 = "SELECT * FROM railway_concession_null WHERE stud_id='1'";
    $result4 = mysql_query($query4);
    $row_4 = mysql_fetch_array($result4);
    while($i<$count){
	$array[] = $row_4;
	$i++;
    }
	...
	if(isset($_POST['Submit'])){
		...
		else if(($student1_course=='mtech1' AND $student1_dept_leave=='') OR ($student2_name!='' AND $student2_course=='mtech2' AND $student2_dept_leave=='') OR ($student3_name!='' AND $student3_course=='mtech3' AND $student3_dept_leave=='') OR ($student4_name!='' AND $student4_course=='mtech4' AND $student4_dept_leave=='') OR ($student5_name!='' AND $student5_course=='mtech5' AND $student5_dept_leave=='') OR ($student6_name!='' AND $student6_course=='mtech2' AND $student6_dept_leave=='')){
			$error = "<font color='red'>Please upload scanned copy of your Department Leave Certificate.</font>";
		}
		else if($student1_course=='mtech1' AND $student1_dept_leave!=='' AND $student1_dept_leave_SizeKB > 200){
		...
		else if($student2_name!='' AND $student2_course=='mtech2' AND $student2_dept_leave!='' AND $student2_dept_leave_SizeKB > 200){
		...
		else if($student3_name!='' AND $student3_course=='mtech3' AND $student3_dept_leave!='' AND $student3_dept_leave_SizeKB > 200){
		...
		else if($student4_name!='' AND $student4_course=='mtech4' AND $student4_dept_leave!='' AND $student4_dept_leave_SizeKB > 200){
		...
		else if($student5_name!='' AND $student5_course=='mtech5' AND $student5_dept_leave!='' AND $student5_dept_leave_SizeKB > 200){
			$error = "<font color='red'>You have uploaded Department Leave of size".$student2_dept_leave_SizeKB." KB, which is larger than 200 KB.</font>";
		}
		else if($student6_name!='' AND $student6_course=='mtech6' AND $student6_dept_leave!='' AND $student6_dept_leave_SizeKB > 200){
		...
		else if(($student1_category=='cat1' AND $student1_caste_certi=='') OR ($student2_name!='' AND $student2_category=='cat2' AND $student2_caste_certi=='') OR ($student3_name!='' AND $student3_category=='cat3' AND $student3_caste_certi=='') OR ($student4_name!='' AND $student4_category=='cat4' AND $student4_caste_certi=='') OR ($student5_name!='' AND $student5_category=='cat5' AND $student5_caste_certi=='') OR ($student5_name!='' AND $student5_category=='cat5' AND $student5_caste_certi=='')){
			$error = "<font color='red'>Please upload scanned copy of your caste certificate.</font>";
		}
		else if($student1_name!='' AND $student1_category=='cat1' AND $student1_caste_certi!='' AND $student1_caste_certi_SizeKB > 200){
		...
		else if($student2_name!='' AND $student2_category=='cat2' AND $student2_caste_certi!='' AND $student2_caste_certi_SizeKB > 200){
		...
		else if($student3_name!='' AND $student3_category=='cat3' AND $student3_caste_certi!='' AND $student3_caste_certi_SizeKB > 200){
		...
		else if($student4_name!='' AND $student4_category=='cat4' AND $student4_caste_certi!='' AND $student4_caste_certi_SizeKB > 200){
		...
		else if($student5_name!='' AND $student5_category=='cat5' AND $student5_caste_certi!='' AND $student5_caste_certi_SizeKB > 200){
		...
		else if($student6_name!='' AND $student6_category=='cat6' AND $student6_caste_certi!='' AND $student6_caste_certi_SizeKB > 200){
...
*/		else if($student1_idFile==''){ 
		...
		/*else if($tnc == NULL){
			...
			if($row_track['edit']=='yes'){		
				$success = "Request successfully submitted. Your booking Application No. is <b>$application_no</b></font>";
				mysql_query("UPDATE railway_concession_1 SET stud_name='$student1_name', webmail='$student1_webmail', age='$student1_age', gender='$student1_gender', roll_no='$student1_roll_number', room_no='$student1_room_number', id_card='$student1_id_newfilename', departure_station='$from_station', arrival_station='$to_station', journey_type='$journey_type', journey_date='$onward_journey', return_date='$return_journey', caste='$student1_category', caste_certi='$student1_caste_certi_newfilename', ticket_pdf='$ticket_newfilename', course='$student1_course', leave_application='$student1_dept_leave_newfilename', date_of_filling='$curdatetime', hostel='$student1_hostel', edit='no' WHERE application_no=$application_no ");
				...
				if($student2_name!=''){
					mysql_query("UPDATE railway_concession_2 SET stud_name='$student2_name', age='$student2_age', gender='$student2_gender', roll_no='$student2_roll_number', room_no='$student2_room_number', id_card='$student2_id_newfilename', caste='$student2_category', caste_certi='$student2_caste_certi_newfilename', course='$student2_course', leave_application='$student2_dept_leave_newfilename', hostel='$student2_hostel' WHERE id=(SELECT id FROM railway_concession_1 WHERE application_no=$application_no) ");
				...
				if($student3_name!=''){
					mysql_query("UPDATE railway_concession_2 SET stud_name='$student3_name', age='$student3_age', gender='$student3_gender', roll_no='$student3_roll_number', room_no='$student3_room_number', id_card='$student3_id_newfilename', caste='$student3_category', caste_certi='$student3_caste_certi_newfilename', course='$student3_course', leave_application='$student3_dept_leave_newfilename', hostel='$student3_hostel' WHERE id=(SELECT id FROM railway_concession_1 WHERE application_no=$application_no) ");
				...
				if($student4_name!=''){
					mysql_query("UPDATE railway_concession_2 SET stud_name='$student4_name', age='$student4_age', gender='$student4_gender', roll_no='$student4_roll_number', room_no='$student4_room_number', id_card='$student4_id_newfilename', caste='$student4_category', caste_certi='$student4_caste_certi_newfilename', course='$student4_course', leave_application='$student4_dept_leave_newfilename', hostel='$student4_hostel' WHERE id=(SELECT id FROM railway_concession_1 WHERE application_no=$application_no) ");
				...
				if($student5_name!=''){
					mysql_query("UPDATE railway_concession_2 SET stud_name='$student5_name', age='$student5_age', gender='$student5_gender', roll_no='$student5_roll_number', room_no='$student5_room_number', id_card='$student5_id_newfilename', caste='$student5_category', caste_certi='$student5_caste_certi_newfilename', course='$student5_course', leave_application='$student5_dept_leave_newfilename', hostel='$student5_hostel' WHERE id=(SELECT id FROM railway_concession_1 WHERE application_no=$application_no) ");
				...
				if($student6_name!=''){
					mysql_query("UPDATE railway_concession_2 SET stud_name='$student6_name', age='$student6_age', gender='$student6_gender', roll_no='$student6_roll_number', room_no='$student6_room_number', id_card='$student6_id_newfilename', caste='$student6_category', caste_certi='$student6_caste_certi_newfilename', course='$student6_course', leave_application='$student6_dept_leave_newfilename', hostel='$student6_hostel' WHERE id=(SELECT id FROM railway_concession_1 WHERE application_no=$application_no) ");
				...
				$error = "<font color='red'>You don't have edit permission.</font>";
			}
		}
	}
...
<!--                ----------------          1     -----------------                -->
							...
							<div class="panel-heading">
								...
								<div class="panel-body">
									...
									<input class="form-control" type="text" value="<?php echo $row_track['stud_name']; ?>" name="student1_name" />									
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Webmail</label>
									<input class="form-control" type="text" value="<?php echo $row_track['webmail']; ?>" name="student1_webmail" />									
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Roll No.</label>
									<input class="form-control" type="number" value="<?php echo $row_track['roll_no']; ?>" name="student1_roll_number" />
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Age</label>
									<input class="form-control" type="number" value="<?php echo $row_track['age']; ?>" name="student1_age" />
								    </div>
								    <div class="col-lg-4">
									...
									<input class="form-control" type="text" value="<?php echo $row_track['hostel']; ?>" name="student1_hostel" />									
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Room No.</label>
									<input class="form-control" type="text" value="<?php echo $row_track['room_no']; ?>" name="student1_room_number" />									
								    </div>
								    <div class="col-lg-4">
									<div class="form-group course1">
										<label class="required">Course</label>
										<select class="form-control" name="student1_course">
											<option value="btech1">B.Tech./B.Des</option>
											<option value="mtech1">M.Tech./PhD</option>
										</select>
									</div>
								    </div>
								    <div class="col-lg-4">
...
<!-- ------------------------------------------      2       ----------------- -------------------- -->
							...
							<div class="panel-heading">
								...
								<div class="panel-body">
								    <div class="form-group col-md-4">
									<label class="required">Name</label>
									<input class="form-control" type="text" value="<?php echo $array[0]['stud_name']; ?>" name="student2_name" />									
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Webmail</label>
									<input class="form-control" type="text" value="<?php echo $array[0]['webmail']; ?>" name="student2_webmail" />									
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Roll No.</label>
									<input class="form-control" type="number" value="<?php echo $array[0]['roll_no']; ?>" name="student2_roll_number" />
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Age</label>
									<input class="form-control" type="number" value="<?php echo $array[0]['age']; ?>" name="student2_age" />
								    </div>
								    <div class="col-lg-4">
									<div class="form-group">
										<label class="required">Gender</label>
								    ...
								    <div class="form-group col-md-4">
									<label class="required">Hostel</label>
									<input class="form-control" type="text" value="<?php echo $array[0]['hostel']; ?>" name="student2_hostel" />									
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Room No.</label>
									<input class="form-control" type="text" value="<?php echo $array[0]['room_no']; ?>" name="student2_room_number" />									
								    </div>
								    <div class="col-lg-4">
									<div class="form-group course2">
										<label class="required">Course</label>
										<select class="form-control" name="student2_course">
											<option value="btech2">B.Tech./B.Des</option>
											<option value="mtech2">M.Tech./PhD</option>
										</select>
									</div>
								    </div>
								    <div class="col-lg-4">
...
<!-- ------------------------------------------      3       ----------------- -------------------- -->
							...
							<div class="panel-heading">
								...
								<div class="panel-body">
								    <div class="form-group col-md-4">
									<label class="required">Name</label>
									<input class="form-control" type="text" value="<?php echo $array[1]['stud_name']; ?>" name="student3_name" />									
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Webmail</label>
									<input class="form-control" type="text" value="<?php echo $array[1]['webmail']; ?>" name="student3_webmail" />									
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Roll No.</label>
									<input class="form-control" type="number" value="<?php echo $array[1]['roll_no']; ?>" name="student3_roll_number" />
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Age</label>
									<input class="form-control" type="number" value="<?php echo $array[1]['age']; ?>" name="student3_age" />
								    </div>
								    <div class="col-lg-4">
									<div class="form-group">
										<label class="required">Gender</label>
								    ...
								    <div class="form-group col-md-4">
									<label class="required">Hostel</label>
									<input class="form-control" type="text" value="<?php echo $array[1]['hostel']; ?>" name="student3_hostel" />									
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Room No.</label>
									<input class="form-control" type="text" value="<?php echo $array[1]['room_no']; ?>" name="student3_room_number" />									
								    </div>
								    <div class="col-lg-4">
									<div class="form-group course3">
										<label class="required">Course</label>
										<select class="form-control" name="student3_course">
											<option value="btech3">B.Tech./B.Des</option>
											<option value="mtech3">M.Tech./PhD</option>
										</select>
									</div>
								    </div>
								    <div class="col-lg-4">
...
<!-- ------------------------------------------      4       ----------------- -------------------- -->
							...
							<div class="panel-heading">
								...
								<div class="panel-body">
								    <div class="form-group col-md-4">
									<label class="required">Name</label>
									<input class="form-control" type="text" value="<?php echo $array[2]['stud_name']; ?>" name="student4_name" />									
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Webmail</label>
									<input class="form-control" type="text" value="<?php echo $array[2]['webmail']; ?>" name="student4_webmail" />									
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Roll No.</label>
									<input class="form-control" type="number" value="<?php echo $array[2]['roll_no'];?>" name="student4_roll_number" />
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Age</label>
									<input class="form-control" type="number" value="<?php echo $array[2]['age'];?>" name="student4_age" />
								    </div>
								    <div class="col-lg-4">
									<div class="form-group">
										<label class="required">Gender</label>
								    ...
								    <div class="form-group col-md-4">
									<label class="required">Hostel</label>
									<input class="form-control" type="text" value="<?php echo $array[2]['hostel'];?>" name="student4_hostel" />									
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Room No.</label>
									<input class="form-control" type="text" value="<?php echo $array[2]['room_number'];?>" name="student4_room_number" />									
								    </div>
								    <div class="col-lg-4">
									<div class="form-group course4">
										<label class="required">Course</label>
										<select class="form-control" name="student4_course">
											<option value="btech4">B.Tech./B.Des</option>
											<option value="mtech4">M.Tech./PhD</option>
										</select>
									</div>
								    </div>
								    <div class="col-lg-4">
...
<!-- ------------------------------------------      5       ----------------- -------------------- -->
							...
							<div class="panel-heading">
								...
								<div class="panel-body">
								    <div class="form-group col-md-4">
									<label class="required">Name</label>
									<input class="form-control" type="text" value="<?php echo $array[3]['stud_name']; ?>" name="student5_name" />									
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Webmail</label>
									<input class="form-control" type="text" value="<?php echo $array[3]['webmail'];?>" name="student5_webmail" />									
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Roll No.</label>
									<input class="form-control" type="number" value="<?php echo $array[3]['roll_no']; ?>" name="student5_roll_number" />
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Age</label>
									<input class="form-control" type="number" value="<?php echo $array[3]['age']; ?>" name="student5_age" />
								    </div>
								    <div class="col-lg-4">
									<div class="form-group">
										<label class="required">Gender</label>
								    ...
								    <div class="form-group col-md-4">
									<label class="required">Hostel</label>
									<input class="form-control" type="text" value="<?php echo $array[3]['hostel']; ?>" name="student5_hostel" />									
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Room No.</label>
									<input class="form-control" type="text" value="<?php echo $array[3]['room_no']; ?>" name="student5_room_number" />									
								    </div>
								    <div class="col-lg-4">
									<div class="form-group course5">
										<label class="required">Course</label>
										<select class="form-control" name="student5_course">
											<option value="btech5">B.Tech./B.Des</option>
											<option value="mtech5">M.Tech./PhD</option>
										</select>
									</div>
								    </div>
								    <div class="col-lg-4">
...
<!-- ------------------------------------------      6       ----------------- -------------------- -->
							...
							<div class="panel-heading">
								...
								<div class="panel-body">
								    <div class="form-group col-md-4">
									<label class="required">Name</label>
									<input class="form-control" type="text" value="<?php echo $array[4]['stud_name']; ?>" name="student6_name" />									
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Webmail</label>
									<input class="form-control" type="text" value="<?php echo $array[4]['webmail']; ?>" name="student6_webmail" />									
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Roll No.</label>
									<input class="form-control" type="number" value="<?php echo $array[4]['roll_no']; ?>" name="student6_roll_number" />
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Age</label>
									<input class="form-control" type="number" value="<?php echo $array[4]['age']; ?>" name="student6_age" />
								    </div>
								    <div class="col-lg-4">
									<div class="form-group">
										<label class="required">Gender</label>
								    ...
								    <div class="form-group col-md-4">
									<label class="required">Hostel</label>
									<input class="form-control" type="text" value="<?php echo $array[4]['hostel']; ?>" name="student6_hostel" />									
								    </div>
								    <div class="form-group col-md-4">
									<label class="required">Room No.</label>
									<input class="form-control" type="text" value="<?php echo $array[4]['room_no']; ?>" name="student6_room_number" />									
								    </div>
								    <div class="col-lg-4">
									<div class="form-group course6">
										<label class="required">Course</label>
										<select class="form-control" name="student6_course">
											<option value="btech6">B.Tech./B.Des</option>
											<option value="mtech6">M.Tech./PhD</option>
										</select>
									</div>
								    </div>
								    <div class="col-lg-4">
					...
					$(window).load(function(){
						...
						<label class="required">Station Of Journey</label>
							...
							<div class="form-group col-lg-6">
								...
								<input type="text" class="form-control" value="<?php echo $row_track['departure_station']; ?>" name="from_station"/>
							</div>
							<div class="form-group col-lg-6">
								<label  class="required">To</label>
								<input type="text" class="form-control" value="<?php echo $row_track['arrival_station']; ?>" name="to_station"/>
							</div>
							</div>
					    </div>
						...
						<div >
							<input class="one" name="journey_type" type="radio" value="one_way" checked>One Way  
							<input class="both" name="journey_type" type="radio" value="both_way"> Both Way
					        </div>
					    </div>
						...
						<div class="input-group date">
							...
							<input id="date_from" type="text" class="form-control datepicker" name="onward" data-date-format="yyyy-mm-dd" value="<?php echo$row_track['journey_date']; ?>">
						</div>
					    </div>
					    <div class="form-group col-lg-3 return">
						<label>Date of Return Journey</label>
						<div class="input-group date">
							<span class="input-group-addon"><i class="fa fa-calendar"></i> </span>
							<input id="date_to" type="text" class="form-control datepicker" name="return" data-date-format="yyyy-mm-dd" value="<?php echo $row_track['return_date']; ?>">
						</div>
					    </div>
					    <div class="form-group col-md-4">
						<label for="ticket" class="">Upload Ticket</label>
					...
					<div class="col-lg-12">
					    <div class="col-lg-12"><input type="checkbox" id="checkme" name="tnc" required class="required"/> I have read all the rules for applying for Railway Concession. <br/></div>
				...
				<?php if($success != ''){ ?>
					...
					<div class="table-responsive" style="overflow-x: hidden;">
						<div class="alert alert-success">
							<?php if(isset($success)) { echo $success,$cur_query; }?>
						</div>
						<table class="table table-striped table-bordered table-hover">
							<tbody>
								...
								<tr>
									...
									<td><b>Return Journey Date:</b> <?php echo $return_journey; ?></td>
