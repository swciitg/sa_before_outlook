	...
	<table>
	   ...
	   <tbody>
		  <tr>
			 ...
			 <td colspan="4"><?php echo $row_print["name_visitors"]; ?></td>
		  </tr>
	   </tbody>
	   <tfoot>
		  <tr>
			 <td colspan="2"><b>Address(s) of the Visitor(s):</b><br>(Please state mobile number / e-mail ID, if any)</td>
			 <td colspan="4"> <?php echo $row_print["add_visitors"]; ?></td>
		  </tr>
		  <tr>
		  ...
		  <tr>
			 <td rowspan="5" colspan="2"><b>Remarks(if any):</b><br>Recommendation from Students’ Affairs<br></br><?php echo $row_print["comment_sa"]; ?></td>
